...
public class Speech2ChessAboutBox extends javax.swing.JDialog {
    ...
    public Speech2ChessAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(speech2chessapp.Speech2ChessApp.class).getContext().getResourceMap(Speech2ChessAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(speech2chessapp.Speech2ChessApp.class).getContext().getActionMap(Speech2ChessAboutBox.class, this);
